...
const project = [
  ...
  {
    id: "02",
    title: "TechInfo — Modern Blog Website",
    category: "Full Stack",
    description: `TechInfo is a modern blog website built with Next.js 15 and TypeScript. From the Admin Panel, users can create blog posts by selecting an Author and Category. Rich text content is written using a custom Tiptap Editor, 
    and images are uploaded securely to Cloudinary.`,
    stack: ["React 19", "Next.js 15", "TailwindCss", "MongoDB", "ShadCN UI"],
    liveUrl: "https://tech-info-client.vercel.app",
    githubUrl: "https://github.com/M-Shourav/TechInfo_client",
    image: project_8,
  },
  {
    id: "03",
